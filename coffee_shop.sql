...
--
-- Host: localhost
-- Generation Time: Mar 06, 2025 at 06:30 AM
...
(34, 'Espresso', 'Bold, rich dark roast with deep chocolate and caramel notes, ideal for intense espresso shots and beverages.', '250.00', 100, 'bean', '20.jpg'),
...
(41, 'Sakura Chan Tumbler', 'Charming tumbler featuring delicate cherry blossoms, perfect for enjoying beverages while adding a whimsical touch to your day.', '850.00', 100, 'mug', '15.jpg'),
(42, 'Bagel', 'Freshly baked bagel with a chewy texture, available in various flavors—perfect for breakfast or a quick snack.', '50.00', 100, 'des', '21.jpg');
...
CREATE TABLE `notificationAdmin` (
  ...
  `adminIDRead` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `notificationAdmin` (`messageID`, `text`, `userID`, `status`, `adminIDRead`, `createTime`, `updateTime`) VALUES
(1, 'You have a new order! Caramel Macchiato is now ready to be prepared', 4, 'Read', 3, '2025-03-05 08:17:38', '2025-03-05 15:09:46'),
(2, 'You have a new order! Muffin is now ready to be prepared', 3, 'Read', 3, '2025-03-06 01:29:40', '2025-03-06 04:59:17'),
(3, 'You have a new order! Coffee Latte is now ready to be prepared', 2, 'Unread', 0, '2025-03-06 05:04:26', '2025-03-06 05:04:26');
...
(4, 3, 'Great news! Your Iced Americano is ready for pickup', 'Unread', '2025-03-06 01:34:37', '2025-03-06 01:34:37'),
(5, 2, 'Great news! Your Coffee Latte is ready for pickup', 'Unread', '2025-03-06 05:05:23', '2025-03-06 05:05:23'),
(6, 2, 'Your Coffee Latte is complete! Thank you for your order.', 'Unread', '2025-03-06 05:05:52', '2025-03-06 05:05:52');
...
(17, 3, 24, 1, 'processing', '2025-03-06 01:29:40'),
(18, 3, 19, 4, 'Ready', '2025-03-06 01:32:45'),
(19, 2, 17, 1, 'Complete', '2025-03-06 05:04:26');
...
--
ALTER TABLE `notifications`
  MODIFY `notiID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
